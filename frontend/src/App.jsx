...
const ProtectedRoute = ({ children, allowedRoles = [], accessToken, userRole }) => {
    console.log('ProtectedRoute evaluating:', { accessToken: !!accessToken, userRole, allowedRoles });
    if (!accessToken) {
...
const AppContent = () => {
    ...
    useEffect(() => {
        const loadAuthState = () => {
            ...
            console.log('loadAuthState:', { storedAccessToken: !!storedAccessToken, storedUserRole });
